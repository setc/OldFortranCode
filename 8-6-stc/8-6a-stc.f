...
* Declaramos todos los valores de la funci¢n a cero.
      ...
      open(11,file='8-6-stc.dat',status='unknown')    ! fichero de escritura
...
!         write (11,*) m,co2c-0.11276*real(i)  !Eliminamos la componente
         write(11,*) m,co2c                                      !lineal.
* defino un contador que sirve de indice a f_k
         k=k+1
         fr(k)=co2c   ! parte real de la senyal muestreada
!         fr(k)=co2c-0.11276*real(i) !Parte real sin la componente
                                     !lineal.
...
*      open(40,file='8-6g11-stc.dat') ! cuando dimensiono por exceso
