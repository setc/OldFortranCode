************************************************************************
*     Ajuste lineal de la concentraci¢n de co2 en Hawai para eliminar  *
*     la componente lineal.                                            *
************************************************************************
      implicit real (a-h,o-z)
      real a,err_a,b,err_b
      integer ndat
...
*     ...  ...
*     x(n) y(n)
      open(10,file='aajustar.dat', blank='null') !Se¤alamos que los
                                              !espacios no cuentan.
