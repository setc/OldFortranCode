...
*ser leido por GNUplot y as¡ dibuje nuestra gr fica.
      ...
      open(20,file='0-11-stc.out', status='unknown')
      write(20,*)'##################################################'
      write(20,*)'#Resultados del ajuste a una linea recta a partir#'
      write(20,*)'#de los datos del documento 0-11-stc.in          #'
      write(20,*)'#       y=a*x+b                                  #'
      write(20,*)'##################################################'
      write(20,*)
      write(20,*)'# a=',a,' con un error de ',err_a
      write(20,*)'# b=',b,' con un error de ',err_b
      write(20,*)'# y=',a,'*x+',b
      write(20,*)'set grid'
      write(20,*)'plot y=',a,'*x+',b
      close (20)
...
*     ...  ...
*     x(n) y(n)
      open(10,file='0-11-stc.in', blank='null') !Se¤alamos que los
                                              !espacios no cuentan.
      read(10,*) ndat !Leemos el numero de datos.
